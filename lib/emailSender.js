...
exports.sendConfirmEmail = (to, token) => {
  ...
  const content = new EmailHelper.Content('text/plain', `Let\'s confirm your email address. \nClick on the following link to confirm: https://gt-hive-api.herokuapp.com/api/v1/auth/confirm-email/${token}\nThis link expires in 12 hours.`);
